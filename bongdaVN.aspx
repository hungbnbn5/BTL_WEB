<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bongdaVN.aspx.cs" Inherits="BTL_WEB.bongdaVN" %>
...
<a href="Current_Post.aspx"> TIN MỚI</a>
    ...
    <div class="vietnam-section">
        ...
        <div class="main-vn-news">
            <img src="anhcw/VN10.png" alt="Trận Nhật Bản vs Hồng Kông" />
            <div class="vn-news-text">
                <h3>Bị loại ở U23 Việt Nam, tiền đạo 1m84 lập tức ghi 2 bàn thắng</h3>
                <p>Trở về sau khi bị loại U23 Việt Nam, tiền đạo Đăng Dương lập tức tỏa sáng trong màu áo của U21 Viettel.</p>
            </div>
        </div>
        ...
        <div class="vn-sub-news">
            <div class="vn-news-item">
                ...
                <p class="sub-title"><strong>Thủ môn ĐT Việt Nam có bước ngoặt lớn trong sự nghiệp</strong></p>
            </div>
            <div class="vn-news-item">
                <img src="anhcw/VN3.png" alt="U23 Việt Nam" />
                <p class="sub-title"><strong>U23 Việt Nam có lợi thế lớn bất ngờ ở giải U23 Đông Nam Á</strong></p>
            </div>
            <div class="vn-news-item">
                <img src="anhcw/VN4.png" alt="Xuân Sơn Hà Lan" />
                <p class="sub-title"><strong>Ngôi sao Hà Lan sắp trở thành đồng đội của Xuân Sơn</strong></p>
            </div>
        </div>

        <div class="vn-bottom-wrapper">
            <div class="vn-schedule">
                <h3 class="vn-title"><span class="highlight">LỊCH THI ĐẤU</span> V LEAGUE 1</h3>
                <p>Chính › <span class="match-date">11-05-2025</span></p>
                <p><strong>Nam Định</strong> 2 - 1 <strong>Thanh Hóa</strong></p>
                <p>Vòng 23 › <span class="match-date">16-05-2025</span></p>
                <p><strong>Hải Phòng</strong> 1 - 1 <strong>Thanh Hóa</strong></p>
            </div>
        ...
        <div class="latest-news">
            ...
            <div class="news-item">
                ...
                <div class="news-content">
                    <h4>Nam Định vào bán kết giải quốc gia</h4>
                    <p class="news-summary">U13 Nam Định là 1 trong 4 đội vào bán kết giải Bóng đá Thiếu niên (U13) toàn quốc Yamaha Cup 2025.</p>
                </div>
            </div>
  ...
  <div class="footer-content">
    ...
    <div class="footer-info">
      ...
      <a href="Lichthidau.aspx">LỊCH THI ĐẤU</a>
      <br>
      <a href="fifa.html">FIFA CLUB WORLD CUP</a>
      <br>
