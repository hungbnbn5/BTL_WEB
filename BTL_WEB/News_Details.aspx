<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsDetail.aspx.cs" Inherits="BTL_WEB.NewsDetail" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Chi Tiết Tin Tức</title>
    <link rel="stylesheet" href="News_Details.css" />
...
<a href="Current_Post.aspx"> TIN MỚI</a>
        ...
        <div class="more-news">
            ...
            <div class="news-items">
                <asp:Literal ID="RelatedPost" runat="server"></asp:Literal>
            </div>
        </div>
